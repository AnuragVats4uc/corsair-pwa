import { WishlistVisibilityEnum } from './enums/WishlistVisibilityEnum.d'
import { GiftCardTypeEnum } from './enums/GiftCardTypeEnum'
import { BadgesEnum } from '@components/common/ProductTile/Badge/Badge'
import { VariantType } from './enums/VariantType.d'
...
export type CategoryInterface = {
    ...
    ribbons?: Maybe<Array<Maybe<RibbonData>>>
}

/** Ribbon data for the header*/
...
export type ConfigurableAttributeOption = {
    ...
    /**Variant text */
    variant_text?: Maybe<Scalars['String']>
}
...
export type CustomerOrder = {
    ...
    /** The order's available actions */
    available_actions?: Maybe<Array<AvailableActions>>
    /** The billing address for the order */
    available_actions: Maybe<Array<Maybe['String']>>
...
export type OrderItemInterface = {
    ...
    status?: Maybe<Scalars['String']>
    /** The item image*/
    image?: Maybe<OrderItemImage>
}

export type OrderItemImage = {
    __typename?: 'OrderItemImage'
    /** Order Item preview image label */
    label: Scalars['String']
    /** Order Item preview image URL */
    src: Scalars['String']
}
...
export type ProductInterface = {
     ...
     */
    attribute_set_id?: Maybe<Scalars['Int']>
    bundle_products?: Maybe<Array<Maybe<ProductInterface>>>
    brand?: Maybe<Scalars['Int']>
    /**
     * Relative canonical URL. This value is returned only if the system setting 'Use
     * Canonical Link Meta Tag For Products' is enabled
    ...
    /** The file name of a swatch image */
    swatch_image?: Maybe<Scalars['String']>
    tech_specs?: Maybe<Array<Maybe<TechSpecsInterface>>>
    /** The relative path to the product's thumbnail image. */
    thumbnail?: Maybe<ProductImage>
    /**
     * The price when tier pricing is in effect and the items purchased threshold has been reached.
     ...
     */
    websites?: Maybe<Array<Maybe<Website>>>
    works_well_with?: Maybe<ArrayMaybe<ProductSkuInfo>>
    max_qty?: Maybe<number>
    ribbons?: Maybe<Array<Maybe<RibbonData>>>
    /**Swatch type Image / Text */
    variant_type?: Maybe<VariantType>
}

/** Product Information used for product just with SKU, code and and ID info */
 ...
 * Product tech specs
 */
export type TechSpecsInterface = {
    code?: Maybe<Scalars['String']>
    value?: Maybe<Scalars['String']>
...
// An array of suggested keywords that populates below the search bar as the user is typing
...
export type RequestReturnItemInput = {
    ...
    selected_custom_attributes?: Maybe<
        Array<Maybe<SelectedCustomAttributeInput>>
    >
}
